...
describe 'Tower.ModelValidation', ->
  ...
  describe 'length, min, max', ->
    test 'field "name", type: "Integer", min: 5, max 7', ->
      min_validator = App.Validatable.validators('integer_min_max')[0]
      max_validator = App.Validatable.validators('integer_min_max')[1]

      record.set 'integer_min_max', 4
      assert.equal min_validator.validate(record, 'integer_min_max', record.get('errors')), false
      assert.equal max_validator.validate(record, 'integer_min_max', record.get('errors')), true

      record.set 'integer_min_max', 5
      assert.equal min_validator.validate(record, 'integer_min_max', record.get('errors')), true
      assert.equal max_validator.validate(record, 'integer_min_max', record.get('errors')), true

      record.set 'integer_min_max', 6
      assert.equal min_validator.validate(record, 'integer_min_max', record.get('errors')), true
      assert.equal max_validator.validate(record, 'integer_min_max', record.get('errors')), true

      record.set 'integer_min_max', 7
      assert.equal min_validator.validate(record, 'integer_min_max', record.get('errors')), true
      assert.equal max_validator.validate(record, 'integer_min_max', record.get('errors')), true

      record.set 'integer_min_max', 8
      assert.equal min_validator.validate(record, 'integer_min_max', record.get('errors')), true
      assert.equal max_validator.validate(record, 'integer_min_max', record.get('errors')), false

    test 'field "name", type: "Integer", length: { min: 5 }', ->
      validator = App.Validatable.validators("integer_min_length")[0]

      record.set 'integer_min_length', 6
      assert.equal validator.validate(record, 'integer_min_length', record.get('errors')), true

      record.set 'integer_min_length', 5
      assert.equal validator.validate(record, 'integer_min_length', record.get('errors')), true

      record.set 'integer_min_length', 4
      assert.equal validator.validate(record, 'integer_min_length', record.get('errors')), false

    test 'field "name", type: "Integer", length: { max: 7 }', ->
      validator = App.Validatable.validators("integer_max_length")[0]

      record.set 'integer_max_length', 6
      assert.equal validator.validate(record, 'integer_max_length', record.get('errors')), true

      record.set 'integer_max_length', 7
      assert.equal validator.validate(record, 'integer_max_length', record.get('errors')), true

      record.set 'integer_max_length', 8
      assert.equal validator.validate(record, 'integer_max_length', record.get('errors')), false

    test 'field "name", type: "Integer", length: { min: 5, max 7 }', ->
      min_validator = App.Validatable.validators('integer_min_max_length')[0]
      max_validator = App.Validatable.validators('integer_min_max_length')[1]

      record.set 'integer_min_max_length', 4
      assert.equal min_validator.validate(record, 'integer_min_max_length', record.get('errors')), false
      assert.equal max_validator.validate(record, 'integer_min_max_length', record.get('errors')), true

      record.set 'integer_min_max_length', 5
      assert.equal min_validator.validate(record, 'integer_min_max_length', record.get('errors')), true
      assert.equal max_validator.validate(record, 'integer_min_max_length', record.get('errors')), true

      record.set 'integer_min_max_length', 6
      assert.equal min_validator.validate(record, 'integer_min_max_length', record.get('errors')), true
      assert.equal max_validator.validate(record, 'integer_min_max_length', record.get('errors')), true

      record.set 'integer_min_max_length', 7
      assert.equal min_validator.validate(record, 'integer_min_max_length', record.get('errors')), true
      assert.equal max_validator.validate(record, 'integer_min_max_length', record.get('errors')), true

      record.set 'integer_min_max_length', 8
      assert.equal min_validator.validate(record, 'integer_min_max_length', record.get('errors')), true
      assert.equal max_validator.validate(record, 'integer_min_max_length', record.get('errors')), false
