class App.Validatable extends Tower.Model
  ...
  @field 'integer_min_max', type: 'Integer', min: 5, max: 7
  @field 'integer_minFunction', type: 'Integer', min: -> 5
  # @field 'integer_lengthWithMinOption', type: 'Integer', length: min: 5

  @field 'integer_min_length', type: 'Integer', length: { min: 5 }
  @field 'integer_max_length', type: 'Integer', length: { max: 7 }
  @field 'integer_min_max_length', type: 'Integer', length: { min: 5, max: 7 }
